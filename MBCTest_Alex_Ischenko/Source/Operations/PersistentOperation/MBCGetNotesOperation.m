...
@implementation MBCGetNotesOperation

- (id<MBCManagedObjectMapper>)createObjectMapper
{
    _mapper = [MBCNotesObjectMapper new];
    return _mapper;
}
...
#pragma mark - Get Notes from some source (e.g web service) -

- (NSArray *)getNotes
{
    NSArray *notes = @[@{@"id":@1, @"text": @"Test Alex First note"},
